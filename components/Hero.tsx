      ...
      <section id="top" className="border-b border-slate-200 bg-slate-50">
        <div className="mx-auto max-w-6xl px-5 py-16 sm:px-8 sm:py-24">
          <div className="max-w-4xl">
            <p className="hero-intro-item hero-intro-delay-80 inline-flex items-center gap-2 text-sm font-bold text-teal-800">
              <Code2 aria-hidden="true" size={18} />
              {profile.role}
            </p>
            <h1 className="hero-intro-item hero-intro-delay-170 mt-5 text-balance text-4xl font-black leading-[1.18] tracking-[-0.03em] text-slate-950 sm:text-6xl">
              {profile.headline}
            </h1>
            <p className="hero-intro-item hero-intro-delay-260 mt-7 max-w-3xl text-pretty text-lg leading-9 text-slate-700 sm:text-xl">
              {profile.summary}
            </p>
            <div className="hero-intro-item hero-intro-delay-360 mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
              <a
                href="#case-studies"
              ...
              >
                主要ケーススタディを見る
                <ArrowDown aria-hidden="true" className="motion-arrow-down" size={17} />
              </a>
              <a
                href="#tech-stack"
          ...
          <dl className="hero-intro-item hero-intro-delay-470 mt-12 grid border-y border-slate-300 sm:grid-cols-3 sm:divide-x sm:divide-slate-300">
